  ...
  return (
    <div className="flex items-end gap-0.5 h-8">
      ...
      <TreeDeciduous
        className={
          actief?.middel
            ? "h-6 w-6 text-status-geaccepteerd-text"
      ...
      <TreeDeciduous
        className={
          actief?.groot
            ? "h-8 w-8 text-status-geaccepteerd-text"
            ...
            <div className="space-y-2">
              ...
              >
                ...
                >
                  ...
                  <TreeDeciduous className="h-6 w-6 shrink-0 text-status-geaccepteerd-text" />
                  <div className="flex-1 min-w-0">
                ...
                >
                  ...
                  <TreeDeciduous className="h-8 w-8 shrink-0 text-status-geaccepteerd-text" />
                  <div className="flex-1 min-w-0">
            ...
            <FormItem>
              ...
              {toonVerkeersmaatregelenWaarschuwing && (
                <div className="flex items-center gap-1.5 pt-1">
                  <Info className="h-3.5 w-3.5 shrink-0 text-status-gepland-text" />
                  <Badge
                    variant="outline"
                    className="text-status-gepland-text border-status-gepland-border bg-status-gepland/40 text-xs"
                  >
              ...
              {heeftVeiligheidsrisico && (
                <Card className="border-status-herinnering-border bg-status-herinnering/40">
                  <CardContent className="flex items-start gap-2 p-3">
                    <AlertTriangle className="mt-0.5 h-4 w-4 shrink-0 text-status-herinnering-text" />
                    <div className="space-y-1">
                      <p className="text-xs font-semibold text-status-herinnering-text">
                        Veiligheidsmaatregelen vereist
                      </p>
                      <ul className="text-xs text-status-herinnering-text space-y-0.5 list-disc list-inside">
            ...
            {watchedValues.aantalBomen > 0 && (
              <div className="rounded-lg bg-muted/50 p-2 text-xs text-muted-foreground space-y-0.5">
                <div>
                  ...
                  {watchedValues.hoogteklasse === "hoog" && (
                    <span className="text-status-herinnering-text"> (hoogwerker nodig)</span>
                  )}
                </div>
                {kroondiameter > 0 && (
                  <div>
