...
const PAKKETTEN = [
  ...
  },
  {
    ...
    stijl: {
      ring: "ring-status-herinnering-dot",
      headerBg: "bg-status-herinnering/40",
      badgeBg: "bg-status-herinnering",
      badgeText: "text-status-herinnering-text",
      buttonVariant: "outline" as const,
    },
  },
] as const;
      ...
      <form>
        <Card>
          ...
          <CardContent className="space-y-6 pt-0">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <AreaInput
                          ...
                          className={errors.tuinOppervlakte ? "border-status-herinnering-border" : ""}
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      <FormControl>
                        <SelectTrigger
                          id="mollen-tuintype"
                          className={errors.tuinType ? "border-status-herinnering-border" : ""}
                        >
            ...
            ---------------------------------------------------------------- */}
            <div className="rounded-lg border border-status-geaccepteerd-border bg-status-geaccepteerd/40 p-4 space-y-2">
              <div className="flex items-center gap-2">
                <TrendingUp className="h-4 w-4 text-status-geaccepteerd-text shrink-0" />
                <p className="text-sm font-semibold text-status-geaccepteerd-text">
                  Dit jaar al 127 mollen verplaatst in uw regio!
                </p>
              </div>
              <div className="flex items-center gap-2">
                <Star className="h-4 w-4 text-status-geaccepteerd-text shrink-0" />
            ...
            ---------------------------------------------------------------- */}
            <div className="rounded-lg border border-status-herinnering-border bg-status-herinnering/40 p-4">
              <div className="flex items-start gap-3">
                <AlertTriangle className="h-4 w-4 text-status-herinnering-text mt-0.5 shrink-0" />
                <div className="space-y-1">
                  <p className="text-sm font-semibold text-status-herinnering-text">
                                  ...
                                  <Badge
                                    className={[
                                      ...
                                      isPremium
                                        ...
                                        : "bg-status-herinnering text-status-herinnering-text",
                                    ].join(" ")}
                                  >
                                    {pakket.badge}
                                  </Badge>
                              ...
                              <Button
                                ...
                                className={[
                                  ...
                                  isSelected && isPremium
                                    ? "bg-primary text-primary-foreground"
                                    : isSelected && isPremiumPlus
                                      ? "border-status-herinnering-border text-status-herinnering-text"
                                      : "",
                                ].join(" ")}
                                tabIndex={-1}
                                aria-hidden="true"
