      ...
      <CardContent className="space-y-3 pt-0">
        ...
        {toonDrainage && (
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-start justify-between rounded-lg border border-status-gepland-border bg-status-gepland/40 p-3 gap-3">
        ...
        {toonBekalken && (
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-start justify-between rounded-lg border border-status-herinnering-border bg-status-herinnering/40 p-3 gap-3">
                <div className="space-y-0.5">
                  <FormLabel className="text-sm font-medium">
                    Bekalken
                  </FormLabel>
          ...
          render={({ field }) => (
            <FormItem className="space-y-0">
              ...
              {aanbevelingen.robotmaaierAdvies && (
                <div className="rounded-lg border border-status-geaccepteerd-border bg-status-geaccepteerd/40 p-3 flex gap-2">
