export { DashboardStatsSkeleton, DashboardCardSkeleton, RecentOffertesListSkeleton, DashboardSkeleton } from "./dashboard-skeletons";
export { TableRowSkeleton, OffertesTableSkeleton, TableSkeleton } from "./table-skeletons";
