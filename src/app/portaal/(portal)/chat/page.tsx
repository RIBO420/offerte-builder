...
export default function PortaalChatPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden h-[calc(100vh-220px)] min-h-[400px]">
        <div className="flex h-full">
          {/* Thread list — visible on desktop always, on mobile only when no thread selected */}
          <div
            className={cn(
              "w-full md:w-[260px] md:border-r border-border md:block shrink-0",
