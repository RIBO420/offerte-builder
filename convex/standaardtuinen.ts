  ...
  aanleg: [
    {
      ...
      defaultWaarden: {
        grondwerk: {
          oppervlakte: 40,
          diepte: "licht" as const,
          afvoerGrond: true,
        },
        bestrating: {
          oppervlakte: 15,
          typeBestrating: "tegel" as const,
    ...
    },
    {
      ...
      defaultWaarden: {
        ...
        bestrating: {
          oppervlakte: 60,
          typeBestrating: "natuursteen" as const,
          snijwerk: "hoog" as const,
          onderbouw: {
            type: "zand_fundering" as const,
            dikteOnderlaag: 15,
            opsluitbanden: true,
        ...
        borders: {
          oppervlakte: 40,
          beplantingsintensiteit: "veel" as const,
          bodemverbetering: true,
          afwerking: "grind" as const,
        },
        gras: {
          oppervlakte: 60,
          type: "graszoden" as const,
        ...
        houtwerk: {
          typeHoutwerk: "vlonder" as const,
          afmeting: 20,
          fundering: "zwaar" as const,
        },
        water_elektra: {
          verlichting: "uitgebreid" as const,
          aantalPunten: 4,
          sleuvenNodig: true,
        },
      },
    ...
    },
    {
      ...
      defaultWaarden: {
        ...
        borders: {
          ...
          onderhoudsintensiteit: "veel" as const,
          onkruidVerwijderen: true,
          snoeiInBorders: "zwaar" as const,
          bodem: "open" as const,
